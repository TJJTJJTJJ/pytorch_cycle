...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels, e.g. 1 or 3')
        parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels, e.g. 1 or 3')
